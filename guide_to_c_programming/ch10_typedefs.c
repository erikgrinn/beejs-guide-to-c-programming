...
// But that’s not all! There’s another common shortcut that you might see in code using what are called anonymous structures83. It turns out you don’t actually need to name the structure in a variety of places, and with typedef is one of them.
